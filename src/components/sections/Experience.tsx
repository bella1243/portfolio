    ...
    <section id="experience" className="section-padding relative" aria-label="Experience">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          <div className="absolute left-4 md:left-1/2 md:-translate-x-px top-0 bottom-0 w-0.5 bg-gradient-to-b from-cyan-500/50 via-blue-500/50 to-purple-500/50" />
          ...
          {experiences.map((exp, i) => (
            ...
            >
              ...
              <motion.div
                ...
                className="absolute left-4 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-cyan-500 border-4 border-[#0a0a0f] [.light_&]:border-slate-200 z-10 shadow-lg shadow-cyan-500/50"
              />
              ...
              <div className={`ml-12 md:ml-0 md:w-1/2 ${i % 2 === 0 ? 'md:pr-12' : 'md:pl-12'}`}>
                ...
                >
                  ...
                  <p className="text-cyan-400 text-sm font-medium mb-4">{exp.role}</p>
